...
export default function list({ cards, view = 'text', klass = 'card', printing, collapsed = true, scrollable = true, imgSize = 300 }) {
  return html`
    <ul class="${klass}__list ${scrollable ? 'scrollable' : ''}">
      ${cards.map(card => html`
